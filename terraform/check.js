                    ...
                    stroke: COLORS.nat, 'stroke-width': '1.5', opacity: '0.75' }, linkLayer);
                    }
                    });
                    ...
                    cols.forEach((c, i) => {
                    svgEl('text', { x: colX[i], y: 40, fill: '#64748b', 'font-size': '11', 'font-weight': '600',
                    'letter-spacing': '1.5', 'text-anchor': 'middle' }, svg).textContent = c.toUpperCase();
                    });
